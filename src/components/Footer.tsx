      ...
      <div className="mx-auto w-full max-w-screen-xl">
        <div className="grid grid-cols-2 gap-8 px-4 py-6 md:grid-cols-4 lg:py-8">
          ...
          <div>
            ...
            <ul className="font-medium text-gray-500 dark:text-gray-400">
              ...
              <li className="mb-4">
                <li className="mb-4">
                  <Link to="/customersafety" className="hover:underline">
                    Customer Safety
                  </Link>
                </li>
              </li>
        ...
        <div className="bg-gray-200 px-4 py-6 dark:bg-gray-700 md:flex md:items-center md:justify-between">
          <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">
            Copyright © 2000-2024, Christiansonline.com.au, All rights reserved.
            ABN: 42 151 803 226 Part of The Baxter Group Pty Ltd.
          </span>
